...
const CATALOG = {
  ...
  fr: {
    ...
    profile: {
      ...
      billing: 'Offre : {value}',
      footer: 'Utilisez les boutons ci-dessous pour ajouter, changer, modifier, réinitialiser ou voir le thème actif.',
  ...
  de: {
    ...
    profile: {
      ...
      billing: 'Tarif: {value}',
      footer: 'Nutze die Buttons unten, um das aktive Profil hinzuzufügen, zu wechseln, zu aktualisieren, zurückzusetzen oder das Horoskop zu sehen.',
  ...
  es: {
    ...
    profile: {
      ...
      billing: 'Plan: {value}',
      footer: 'Usa los botones de abajo para añadir, cambiar, actualizar, restablecer o ver la carta activa.',
